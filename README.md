...
Image2 AI 生图系统是一个面向中文用户的 AI 生图 Web 应用，目标是提供类似 image2.fun 的轻量化创作体验。项目内置提示词库、DeepSeek 提示词润色、生图任务、作品历史、积分账户、后台配置和拟 App 风格 WebUI，适合用于学习、二次开发或搭建自己的 AI 图片生成站点。

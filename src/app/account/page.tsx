    ...
    return (
      <main className="mx-auto max-w-xl pb-28">
        <SpotlightCard className="p-6 text-center">
          ...
          <BlurText as="h1" text="账户与积分" className="mt-5 text-3xl font-black text-slate-950" delay={0.035} />
    ...
    <main className="space-y-5 pb-28">
      <SpotlightCard className="p-5">
        ...
        <div className="mt-2 flex flex-wrap items-end justify-between gap-3">
          <div>
            <BlurText as="h1" text="账户与积分" className="text-3xl font-black text-slate-950" delay={0.035} />
